...
X <- read.csv("/Users/ipapasta/Documents/Research/Software/R/grid_fields_old/M12_2018-04-10_14-22-14_of/session.csv", stringsAsFactors=FALSE)
## Y <- read_excel("/home/ipapasta/Software/R/grid_fields/mouse_5_cell_6/mouse5_spatial_data_firing_events.xlsx")
Y <- read.csv("/Users/ipapasta/Documents/Research/Software/R/grid_fields_old/M12_2018-04-10_14-22-14_of/2_firing_events.csv", stringsAsFactors=FALSE)
