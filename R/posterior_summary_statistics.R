...
pdf("marginal_posterior_hyperparameters_M0_M1.pdf")
...
## direction2
posterior.gridness.score.M0         <- posterior.spatial.gridness.score(fit.space, theta.mapping=function(x) theta.2.phi(x, l=l, u=u))
posterior.osc.circ.score.M1         <- posterior.directional.gridness.score(fit.space.direction2, theta.mapping=function(x) theta.2.phi(x, l=l, u=u))
posterior.gridness.score.M1         <- posterior.spatial.gridness.score(fit.space.direction2, theta.mapping=function(x) theta.2.phi(x, l=l, u=u))
posterior.spatial.stdev.M0          <- posterior.spatial.standard.deviation(fit.space)
posterior.spatial.stdev.M1          <- posterior.spatial.standard.deviation(fit.space.direction2)
posterior.spatial.range.M0          <- posterior.spatial.range(fit.space)
posterior.spatial.range.M1          <- posterior.spatial.range(fit.space.direction2)
## 
posterior.range.M0     <- posterior.spatial.range(fit.space)
posterior.range.M1     <- posterior.spatial.range(fit.space.direction2)
## 
posterior.directional.stdev.M1          <- posterior.directional.standard.deviation(fit.space.direction2)
posterior.directional.range.M1          <- posterior.directional.range(fit.space.direction2)
posterior.directional.kappa.M1          <- posterior.directional.kappa(fit.space.direction2)
## 
## 
##
