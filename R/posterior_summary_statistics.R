...
## 
## par(mfrow=c(1,2))
plot(posterior.spatial.stdev.M0, type="l", xlim=c(0,10), ylim=c(0, 2))
lines(seq(0, 10, len=1000), dexp(seq(0, 10, len=1000), 1/2), lty=2)
plot(posterior.spatial.stdev.M1, type="l", xlim=c(0,10), ylim=c(0, 2))
lines(seq(0, 10, len=1000), dexp(seq(0, 10, len=1000), 1/2), lty=2)
## 
## par(mfrow=c(1,2))
plot(posterior.spatial.range.M0, type="l", xlim=c(0,60), ylim=c(0, .61))
lines(seq(0, 100, len=1000), dlnorm(seq(0, 100, len=1000), log(25), 3), lty=2)
plot(posterior.spatial.range.M1, type="l", xlim=c(0,60), ylim=c(0, .61))
lines(seq(0, 100, len=1000), dlnorm(seq(0, 100, len=1000), log(25), 3), lty=2)
...
par(mfrow=c(1,2))
plot(posterior.directional.stdev.M1, type="l", xlim=c(0,10), ylim=c(0, 2))
lines(seq(0, 10, len=1000), dexp(seq(0, 10, len=1000), sigma.directional), lty=2)
## 
## par(mfrow=c(1,2))
plot(posterior.directional.range.M1, type="l", xlim=c(0,10), ylim=c(0, 4))
